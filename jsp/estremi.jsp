...
<div class="container-fluid text-center">    
 ...
 try{
            ...
            String sql = "SELECT * FROM Cantante WHERE DataDiNascita > ? AND DataDiNascita < ?";
    	   
    	    PreparedStatement stmt = connection.prepareStatement(sql);		
    		stmt.setString(1, datamin);
    		stmt.setString(2, datamax);
            Result rs = stmt.executeQuery();
            out.println("LISTA DEI GIUDICI NATI TRA "+datamin+" e "+datamax);
            out.println("<tr><th align=left>Cognome</th><th align=left>Nome</th><th align=left>Data di nascita</th><th align=left>Luogo di nascita</th></tr>");
