...
<div class="container-fluid text-center">    
 ...
 try {
            ...
            String sql1 = "SELECT COUNT(ID) as Numero FROM Cantante WHERE Nome = ? AND Cognome = ?";
            ...
            rs.close();
            if(numero == 0){ %>
            <h1>Non ci sono cantanti che si chiamano <%= nome cognome%></h1> <%
            } else {
    		...
    		while(rs.next()){
                ...
                out.println("<tr><td>" + Cognome + "</td><td>" + Nome + "</td></tr>");
